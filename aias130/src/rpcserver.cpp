...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Aias features */
        {"aias", "masternode", &masternode, true, true, false},
        {"aias", "listmasternodes", &listmasternodes, true, true, false},
        {"aias", "getmasternodecount", &getmasternodecount, true, true, false},
        {"aias", "masternodeconnect", &masternodeconnect, true, true, false},
        {"aias", "masternodecurrent", &masternodecurrent, true, true, false},
        {"aias", "masternodedebug", &masternodedebug, true, true, false},
        {"aias", "startmasternode", &startmasternode, true, true, false},
        {"aias", "createmasternodekey", &createmasternodekey, true, true, false},
        {"aias", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"aias", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"aias", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"aias", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"aias", "getmasternodescores", &getmasternodescores, true, true, false},
        {"aias", "mnbudget", &mnbudget, true, true, false},
        {"aias", "preparebudget", &preparebudget, true, true, false},
        {"aias", "submitbudget", &submitbudget, true, true, false},
        {"aias", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"aias", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"aias", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"aias", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"aias", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"aias", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"aias", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"aias", "checkbudgets", &checkbudgets, true, true, false},
        {"aias", "mnsync", &mnsync, true, true, false},
        {"aias", "spork", &spork, true, true, false},
        {"aias", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"aias", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use aiasd, or the -server option to aias-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
    ...
    for (int i = 0; i < GetArg("-rpcthreads", 50); i++)
...
{
    return "> aias-cli " + methodname + " " + args + "\n";
}

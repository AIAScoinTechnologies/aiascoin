                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Aias Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aias address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aias: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for AIAS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Aias Core"), this);
    aboutAction->setStatusTip(tr("Show information about Aias Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Aias"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aias addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aias addresses"));
    ...
    openAction->setStatusTip(tr("Open a Aias: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aias Core help message to get a list with possible Aias command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Aias Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aias network", "", count));
}
...
{
    QString strTitle = tr("Aias Core"); // default title

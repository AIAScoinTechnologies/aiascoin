Contributing to Aias Core
============================

The Aias Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Aias Core project, and is not to be
confused with overall Aias Network Protocol consensus changes.

Whether a pull request is merged into Aias Core rests with the project merge
...
Patches that change Aias consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aias consensus, it must have been
...
The project leader is the release manager for each Aias Core release.

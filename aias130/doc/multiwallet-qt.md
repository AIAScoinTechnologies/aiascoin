...
In order to support loading of multiple wallets in aias-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aias.cpp.
...
Changes to aias.cpp
----------------------
aias.cpp is the entry point into aias-qt, and as such, will require some minor modifications to provide hooks for

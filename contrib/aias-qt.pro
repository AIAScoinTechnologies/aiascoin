...
RESOURCES += src/qt/aias.qrc src/qt/aias_locale.qrc

TRANSLATIONS += src/qt/locale/aias_bg.ts \
                src/qt/locale/aias_de.ts \
                src/qt/locale/aias_en.ts \
                src/qt/locale/aias_es.ts \
                src/qt/locale/aias_fi.ts \
                src/qt/locale/aias_fr.ts \
                src/qt/locale/aias_it.ts \
                src/qt/locale/aias_ja.ts \
                src/qt/locale/aias_pl.ts \
                src/qt/locale/aias_pt.ts \
                src/qt/locale/aias_ru.ts \
                src/qt/locale/aias_sk.ts \
                src/qt/locale/aias_sv.ts \
                src/qt/locale/aias_vi.ts \
                src/qt/locale/aias_zh_CN.ts \
                src/qt/locale/aias_zh_TW.ts
